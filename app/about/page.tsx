...
export default function About() {
  return <main className="subpage">
    ...
    <section className="company-facts"><div className="shell"><div><strong>5</strong><span>공개 프로젝트</span></div><div><strong>23</strong><span>연결한 오픈소스</span></div><div><strong>4</strong><span>핵심 수행 영역</span></div><p>작은 실험으로 시작해<br /><b>운영 가능한 시스템까지.</b></p></div></section>
