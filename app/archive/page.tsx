...
export default function Archive() {
  return <main className="subpage">
    ...
    <section className="shell archive-tools"><div className="search-box">⌕ <input aria-label="프로젝트 검색" placeholder="프로젝트, 해결한 문제 또는 오픈소스 검색" /></div><div className="filters"><button className="active">전체 {projects.length}</button><button>구축 중 2</button><button>검증 중 1</button><button>운영 중 1</button></div></section>
